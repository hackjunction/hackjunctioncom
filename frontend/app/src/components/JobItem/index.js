        ...
        >
            <div className="JobItem--head">
                ...
                <div className="JobItem--title-container">
                    ...
                    <span className="JobItem--location">
                        {location}
                    </span>
                    <br/>
                    <span className="JobItem--date" style={{ opacity: open ? "0%" : "100%", userSelect: open ? "none" : "text" }}>
                        Application ends: <br/>
                        {endDate}
                    </span>
                </div>
            ...
            <AnimateHeight duration={300} height={open ? "auto" : 0}>
                ...
                <a class="JobItem--link" href={link} target="blank">Read More &gt;</a>
            </AnimateHeight>
            <i className="icon-right-open JobItem--arrow" onClick={() => setOpen(!open)} />
        </div>
    );
};
