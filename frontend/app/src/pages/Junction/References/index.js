    ...
    render() {
        return (
            ...
            >
                ...
                <div className="ReferencesPage--DownContent">
                    <div className="ReferencesPage--DownContent--Img">
                        <img
                            src={require("../../../assets/images/references/ericsson.png")}
                            width="80%"
                        />
                    </div>
                    <div className="ReferencesPage--DownContent--Text">
                        <h3>Case Ericssson</h3>
                        <p>
                            In 2019 Ericsson attended Junction for the second
                            time as a Track Owner with two challenges that had
                            different goals: one to attract as many participants
                            as possible, and the other to work on the themes of
                            the real R&D pipeline, also while offering a
                            competitive element. The first was titled “Security
                            Awareness for Kids” and the second “Greener City
                            Transport with 5G”.
                        </p>
                        <p>
                            Security and usability seldom go hand-in-hand, and
                            one approach to this is through children: they have
                            most of the same security concerns as adults, but as
                            users are very different, very complicated solutions
                            do not work here. In the 5G challenge, Ericsson
                            first had multiple iterations of the idea for the
                            challenge and once decided, prepared the necessary
                            tech (APIs, cloud, visual application).
                        </p>
                        <p>
                            “At the end 36 teams took our Security awareness for
                            kids -challenge and 14 teams our Greener city
                            transport with 5G -challenge. Just amazing! But of
                            course, the greatest thing of all was that Tassu
                ...
                <div className="ReferencesPage--DownContent">
                    <div className="ReferencesPage--DownContent--Text">
                        ...
                        <p>
                            ...
                            company committed to fighting for a world without
                            the fear of cancer. Globally they have over 10 000
                            employees. In Finland, 270 professionals develop
                            radiation therapy software, which is used to help
                            patients of every Finnish cancer clinic.
                        </p>
                        <p>
                            Varian participated in Junction 2019 with a
                            challenge on how to improve the workflow of the
                            physician when approving and reviewing a treatment
                            plan. The participants had access to previous plans
                            and a database API, along with professionals from
                            the Varian team.
                        </p>
                        <p>
                            The projects introduced collaborative aspects to
                            planning treatment between doctors and planners in
